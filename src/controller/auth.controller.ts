...
export class AuthController {
    ...
    async register(req: RegisterUser, res: Response, next: NextFunction) {
        ...
        try {
            const user = await this.userservice.create({ firstName, lastName, email, password, role: Role.CUSTOMER })
    ...
    async login(req: RegisterUser, res: Response, next: NextFunction) {
        ...
        try {
            ...
            //// match password 
            const passwordMatch = await this.credetialservice.comparePassword(password, user.password)
